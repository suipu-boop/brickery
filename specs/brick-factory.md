...
## 设计原则：有用的新奇（2026-08-18 用户拍板）

模块就是小积木，新奇度要多做文章——**但不是为了新奇，而是要做有用的新奇**。

- 新奇是钩子，有用才是价值；新奇让积木让人想点开，有用让人留下用
- 每个新奇积木都要回答"它解决了什么/带来了什么"，答不上来就只是玩具
- 例子：小游戏积木的新奇在"agent 自带游戏入口"，有用在演示/休闲/降低上手门槛；
  画图板的新奇在"用积木拼出创作能力"，有用在让产出 agent 能做可视化表达
- 判断标准：新奇负责让人眼前一亮，有用负责让人第二天还来
